...
export function NewQuoteForm({ customers }: { customers: Customer[] }) {
  ...
  return (
    <form action={createQuoteAction} className="card p-6 space-y-4 max-w-xl">
      <div>
      ...
      <div>
        ...
        <input name="title" required className="input" placeholder="Describe the work being quoted" />
      </div>
